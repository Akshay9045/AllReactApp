...
//TODO: DONEE add firebase
import firebase from "firebase/app";

// context stuffs
//TODO:  DONEE import context and action: update and single_contact
...
const Contact = ({ contact, contactKey }) => {
  //TODO: DONEE destructuring dispatch from the context
  ...
  const deleteContact = () => {
    //TODO: DONEE create this method from firebase
    firebase
      .database()
  ...
  const updateImpContact = () => {
    //TODO: DONEE update (star) contact, use contactKey
    firebase
      .database()
      .ref(`/contacts/${contactKey}`)
      .update(
